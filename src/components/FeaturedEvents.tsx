    ...
    <section className="py-20 bg-[#111]">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card rounded-lg overflow-hidden shadow-lg opacity-0 translate-y-10 transition-all duration-700 animate-on-scroll">
            ...
            <div className="card rounded-lg overflow-hidden shadow-lg opacity-0 translate-y-10 transition-all duration-700 delay-100 animate-on-scroll">
              <div className="relative h-48 overflow-hidden">
                <img 
            ...
            <div className="card rounded-lg overflow-hidden shadow-lg opacity-0 translate-y-10 transition-all duration-700 delay-200 animate-on-scroll">
              <div className="relative h-48 overflow-hidden">
                <img 
