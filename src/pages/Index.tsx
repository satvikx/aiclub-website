            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="lg:w-1/2 opacity-0 translate-y-10 transition-all duration-700 animate-on-scroll">
                <div className="relative">
                  <div className="absolute -inset-1 bg-purple-300 opacity-20 blur-lg rounded-lg"></div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="lg:w-1/2 order-1 lg:order-2 opacity-0 translate-y-10 transition-all duration-700 delay-200 animate-on-scroll">
                <div className="relative">
                  <div className="absolute -inset-1 bg-blue-400 opacity-20 blur-lg rounded-lg"></div>
                  <div className="relative bg-[#1a1a1a] p-4 rounded-lg border border-gray-800">
                    <img 
